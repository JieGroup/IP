...
# from app.exception import bad_request, error_response
# from app.authentication import token_auth, basic_auth
# from app.utils import obtain_user_id_from_token
# from app.utils import log, generate_msg, validate_password, send_email, generate_confirmation_token, confirm_token
# from app.utils import generate_password, verify_token_user_id_and_function_caller_id
...
# @api_bp.route('/confirm_email/<token>', methods=['GET'])
# @handle_response
...
# @api_bp.route('/forgot', methods=['POST'])
# @handle_response
# def forgot():
...
# @api_bp.route('/forgot/new/<token>', methods=['GET', 'POST'])
# @handle_response
...
# @api_bp.route('/get_user/<string:id>', methods=['GET'])
...
# @api_bp.route('/update_user/<string:id>', methods=['PUT'])
# @token_auth.login_required
# @handle_response
# def update_user(id):
...
# @api_bp.route('/delete_user/<string:id>', methods=['DELETE'])
# @token_auth.login_required
# @handle_response
# def delete_user(id):
#     '''
