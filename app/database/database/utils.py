...
def Serialize_data(
    data: dict[str, Any]
) -> dict[str, Serializable_Datatype]:

    '''
        Some part of data may be not serializable, ex. type[datetime],
        set. We need to serialize the data.
    '''
